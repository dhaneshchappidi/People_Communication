...
public class Full_Notice extends AppCompatActivity {
    ActionBar actionBar;
    Intent intent;
    TextView n_title,n_desc,n_year,n_branch,u_name,u_time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full__notice);
        ...
        n_title=(TextView)findViewById(R.id.no_title);
        n_desc=(TextView)findViewById(R.id.no_desc);
        n_year=(TextView)findViewById(R.id.no_year);
        n_branch=(TextView)findViewById(R.id.no_branch);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot ds:dataSnapshot.getChildren()){
                    String title="" + ds.child("ntitle").getValue();
                    String desc="" + ds.child("ndesc").getValue();
                    String year="" + ds.child("nyear").getValue();
                    String branch="" + ds.child("nbranch").getValue();
